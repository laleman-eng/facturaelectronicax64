...
set Version=92.1.017
call "%VS110COMNTOOLS%vsvars32.bat"

msbuild "Factura Electronica VK.sln" /t:Clean,Build  /p:Configuration="Debug SAP910 x86" /p:PlatformTarget=x86
...
:INNO
"C:\Program Files (x86)\Inno Setup 5\iscc.exe" "C:\Users\ajose\Documents\VisualK\Proyectos\Factura Electronica VK 2\Factura Electronica.iss"
